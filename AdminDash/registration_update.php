...
$con = mysqli_connect("localhost", "root", "");
mysqli_select_db($con, "the_scrap_service");
if (isset($_POST["update"])) //["ins"] in this ins is submit button name
{
    ...
    $q="update tbl_registration set user_id='$user_id',user_name='$user_name',email='$email',mobile_number='$mobile_number' where user_id='$uid' ";
   
    $t=mysqli_query($con,$q);
    if($t)
    {
      echo"<script>alert('data has updated')</script>";
    }
    else{
